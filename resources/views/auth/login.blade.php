...
<body>
    ...
    <!-- <div class="w-50 position-absolute top-50 start-50 translate-middle card p-5">
        <h1 class="text-center text-info" style="font-weight:800">LOGIN ADMIN</h1>
        <form action="{{ route('login') }}" method="POST">
            ...
            <button type="submit" class="w-25 btn btn-primary position-absolute bottom-0 start-50 translate-middle-x mb-3 mt-2">Submit</button>
        </form>
    </div> -->
                        ...
                        <form action="{{ route('login') }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control" name="password" class="form-control"
                                    id="exampleInputPassword1" required i>
                            </div>
