...
<body>
    <div class="container mt-5 d-flex justify-content-center align-items-center">
        <div class="card p-5" style="width: 100vh;">
            <h1 class="text-center" style="font-weight: 700">Login</h1>
            <p class="text-center">Masuk Dashboard Berita</p>
            <form action="#" method="POST">
                ...
                <div class="d-flex justify-content-center row">
                    <button type="submit" class="btn btn-primary" style="font-weight: 650">MASUK</button>
                </div>
            </form>
        </div>
    </div>
